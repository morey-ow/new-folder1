## taken from https://medium.com/analytics-vidhya/simulating-the-solar-system-with-under-100-lines-of-python-code-5c53b3039fc6
...
class Object:                   # define the objects: the Sun, Earth, Mercury, etc
    def __init__(self, name, rad, color, r, v):
        ...
        self.xs = [] #this will hold the x coords of the planet at each point in time
        self.ys = []
        self.plot = vp.sphere(pos=vp.vector(r), color=color, s=rad**2, edgecolors=None, zorder=10) #we plot the initial position of the object
...
for i, nasaid in enumerate([1,2,3,4]):  # The 1st, 2nd, 3rd, 4th planet in solar system
    ...
    #next line just writes the names of the planets                     
...
ani = animation.FuncAnimation(fig, animate, repeat=False, frames=sim_duration, blit=False, interval=20)
plt.show()
